...
Route::prefix('mod-events')->middleware(['web', 'auth', 'prevent-back-history'])->group(function () {
    ...
    Route::get('/accommodation-delegations/export-excel', [AccommodationController::class, 'exportAccommodationDelegations'])->name('accommodation-delegations.export-excel');
    ...
    Route::get('/accommodations/hotel/{id}/export-excel', [AccommodationController::class, 'exportHotelAccommodations'])->name('accommodations.export-hotel');
    ...
    // Delegation Heads Invitations Report
    Route::get('/reports/heads-invitations', [ReportController::class, 'delegationHeadsInvitations'])->name('report.heads-invitations');
    Route::post('/heads-invitations/bulk-export-pdf', [ReportController::class, 'exportBulkDelegationHeadsInvitationsPdf'])->name('heads-invitations.bulk-exportPdf');

    // VIP Report
    Route::get('/reports/vip', [ReportController::class, 'vipReport'])->name('report.vip');
    Route::post('/vip/bulk-export-pdf', [ReportController::class, 'exportBulkVipPdf'])->name('vip.bulk-exportPdf');

    // Wives Report
    Route::get('/reports/wives', [ReportController::class, 'wivesReport'])->name('report.wives');
    Route::post('/wives/bulk-export-pdf', [ReportController::class, 'exportBulkWivesPdf'])->name('wives.bulk-exportPdf');
    ...
    // Hotels Delegations Report
    Route::get('/reports/hotels-delegations', [ReportController::class, 'hotelsDelegationsReport'])->name('report.hotels-delegations');
    Route::post('/hotels-delegations/bulk-export-pdf', [ReportController::class, 'exportBulkHotelsDelegationsPdf'])->name('hotels-delegations.bulk-exportPdf');

    // Delegation Heads Invitations Report
    Route::get('/reports/heads-invitation-statistics', [ReportController::class, 'delegationHeadsInvitationStatistics'])->name('report.heads-invitation-statistics');
    Route::post('/heads-invitation-statistics/bulk-export-pdf', [ReportController::class, 'exportBulkDelegationHeadsInvitationStatisticsPdf'])->name('heads-invitation-statistics.bulk-exportPdf');
