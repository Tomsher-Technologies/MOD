...
@section('content')
    ...
    <div>
        <div class="flex flex-wrap items-center justify-between gap-2 mb-6">
            <h2 class="font-semibold mb-0 !text-[22px]">{{ __db('arrivals_report') }}</h2>
        </div>
        <div class="flex flex-wrap items-center justify-between gap-2 mb-6">
            ...
            <form class="w-[75%] me-4" method="GET">
                <div class="flex relative">
                    ...
                    <div class="flex flex-row w-[70%] gap-4">
                        ...
                        <div class="w-[50%]">
                            <select name="airport[]" multiple data-placeholder="{{ __db('select') }} {{ __db('airport') }}"
                    ...
                    <div class="w-[30%]">
                        ...
                        <a href="{{ route('report.delegation-arrivals') }}"
            ...
            <div class="flex gap-3 ms-auto">
                @directCanany(['export_arrivals_report'])
                    <form action="{{ route('delegation-arrivals.bulk-exportPdf') }}" method="POST" style="display:inline;">
                        @csrf
                ...
                <table style="width: 100%; border-collapse: collapse; border: 2px solid #000; border-bottom: 0;">
                    <thead>
                        <tr style="background-color: #d9d9d9;">
                            ...
                            <th style="padding: 8px; border: 2px solid #000; text-align: center;">{{ __db('flight_name') }}
                            </th>
                    ...
                    <tbody style="text-align: center;">
                        @forelse ($delegates as $key => $delegate)
                            ...
                            <tr>
                                ...
                                <td style="padding: 8px; border: 2px solid #000; text-align: center;">{{ $arrival?->flight_name ?? '-' }}</td>
                                <td style="padding: 8px; border: 2px solid #000; text-align: center;">
