                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                    @php
                        $reports = [
                            ...
                            ['slug' => 'view_drivers_report','name' => 'Drivers Report','url' => route('report.drivers')],
                            ['slug' => 'view_escorts_report','name' => 'Escorts Report','url' => route('report.escorts')],
                            ['slug' => 'view_hotel_room_vacancies','name' => 'Hotel Room Vacancies Report','url' => route('hotel-rooms')],
