@extends('layouts.admin_account', ['title' => 'Edit Role'])

@section('content')
<div class="dashboard-main-body ">
    <div class="flex flex-wrap items-center justify-between gap-2 mb-6 mb-10">
        <h2 class="font-semibold mb-0 !text-[22px]">Edit Role Details</h2>
    ...
    <form action="{{ route('roles.update', $role->id) }}" method="POST" autocomplete="off">
        ...
        <div class="bg-white rounded-lg p-6 mb-10 mt-4">
            <div class="bg-white p-6 grid grid-cols-1 gap-5 mb-4">
                <!-- Date & Time -->
                <div>
                    <label class="form-label block mb-1 text-gray-700 font-medium text-base">Role Name <span class="text-danger">*</span></label>
                    <input  placeholder="Enter role name" value="{{ old('name', $role->name) }}" id="name" name="name" type="text" class="p-3 rounded-lg w-1/2 border text-sm border-neutral-300 text-neutral-600 focus:border-primary-600 focus:ring-0">
                    @error('name')
                ...
                <div class="" >
                    <label class="form-label block text-gray-700 font-semibold text-base">Permissions <span class="text-danger">*</span></label>
                    <div class="w-full">
            ...
            <div class="flex justify-start items-center gap-5">
                <button type="submit" class="btn text-md  !bg-[#B68A35] text-white rounded-lg h-12 mr-4">Submit</button>
            </div>
        </div>
