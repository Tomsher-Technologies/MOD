...
<div class="dashboard-main-body ">
    <div class="flex flex-wrap items-center justify-between gap-2 mb-6 mb-10">
        <h2 class="font-semibold mb-0 !text-[22px]">Create New Role</h2>
        ...
        <div class="bg-white rounded-lg p-6 mb-10 mt-4">
            <div class="bg-white p-6 grid grid-cols-1 gap-5 mb-4">
                ...
                <div>
                    ...
                    <input  placeholder="Enter role name" value="{{ old('name') }}" id="name" name="name" type="text" class="p-3 rounded-lg w-1/2 border text-sm border-neutral-300 text-neutral-600 focus:border-primary-600 focus:ring-0">
                    @error('name')
