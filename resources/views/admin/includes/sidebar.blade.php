            ...
            @can('manage_escorts')
                <li>
                    <a href="{{ route('escorts.index') }}"
                        ...
                        <svg class="pe-2" width="30" height="30" viewBox="0 0 29 29" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
            ...
            @can('manage_drivers')
                <li>
                    <a href="{{ route('drivers.index') }}"
                        ...
                        <svg class="pe-2" width="30" height="30" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-car-front-icon lucide-car-front">
            ...
            @can('manage_accommodations')
                <li>
                    <a href="{{ route('accommodations.index') }}"
                        ...
                        <svg class="pe-2" width="30" height="30" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                            <path stroke-linecap="round" stroke-linejoin="round"
