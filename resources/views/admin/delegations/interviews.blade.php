@extends('layouts.admin_account', ['title' => __db('interview_requests')])
...
@section('content')
            ...
            <div class="xl:col-span-12 h-full">
                <div class="bg-white h-full vh-100 max-h-full min-h-full rounded-lg border-0 p-6">
                    <div class=" mb-4 flex items-center justify-between gap-3">
                        <form class="w-[50%] me-4" action="{{ route('delegations.interviews') }}" method="GET">
                            <div class="relative">
                                ...
                                <input type="search" id="default-search" name="search"
                                    ...
                                    placeholder="Search by Delegation Code, Delegate Name"
                            ...
                            [
                                ...
                                'render' => function ($row) {
                                    if ($row->type === 'del_del') {
                                        ...
                                        $names = $interviewees
                                            ->map(
                                                fn($im) => e($im->delegate->name_en ?? ($im->delegate->name_ar ?? '-')),
                                            )
                                            ->filter()
                                            ->implode('<br>');
    ...
    <div id="filter-drawer"
        ...
        <form action="{{ route('delegations.interviews') }}" method="GET">
            <div class="flex flex-col gap-4 mt-4">
                ...
                <select name="status_id" class="w-full bg-white !py-3 text-sm !px-6 rounded-lg border text-secondary-light">
                    <option value="">{{ __db('all_statuses') }}</option>
