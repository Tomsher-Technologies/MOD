                    ...
                    $columns = [
                        ...
                        [
                            ...
                            'render' => function ($member) {
                                ...
                                $isActive =
                                    $statusVal === 'active' || $statusVal === 'completed' || $member->status == 1;
                        ...
                        [
                            ...
                            'render' => function ($member) {
                                $btn = '';
                                if (auth()->user() && auth()->user()->can('edit_other_interview_members')) {
                                    $btn .=
                                        '<a href="' .
                                        route('otherInterviewMembers.edit', ['id' => base64_encode($member->id)]) .
                                        '" title="' .
                                        __db('edit') .
                                        '" class="w-8 h-8 bg-[#FBF3D6] text-primary-600 dark:text-primary-400 rounded-full inline-flex items-center justify-center me-2">';
                                    $btn .=
                                ...
                                if (auth()->user() && auth()->user()->can('view_other_interview_members')) {
                                    $btn .=
                                        '<a href="' .
                                        route('otherInterviewMembers.show', ['id' => base64_encode($member->id)]) .
