                    ...
                    <div class="delegate-row border bg-white p-6 rounded bg-gray-100 mb-2">
                        <div class="grid grid-cols-12 gap-5">
                            ...
                            <div class="col-span-6">
                                ...
                                <input type="text" id="name_en" name="name_en" class=" p-3 rounded-lg w-full border text-sm border-neutral-300 text-neutral-600 focus:border-primary-600 focus:ring-0" value="{{ old('name_en') }}">
                                @error('name_en')
                            ...
                            <div class="col-span-6">
                                ...
                                <input type="text" id="name_ar" name="name_ar" class=" p-3 rounded-lg w-full border text-sm border-neutral-300 text-neutral-600 focus:border-primary-600 focus:ring-0" value="{{ old('name_ar') }}">
                                @error('name_ar')
                                    <div class="text-red-600">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-span-3">
                                ...
                                <input type="datetime-local" name="start_date" id="start_date" class=" p-3 rounded-lg w-full border text-sm border-neutral-300 text-neutral-600 focus:border-primary-600 focus:ring-0" value="{{ old('start_date') }}">
                                @error('start_date')
                                    <div class="text-red-600">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-span-3">
                                ...
                                <input type="datetime-local" name="end_date" id="end_date" class=" p-3 rounded-lg w-full border text-sm border-neutral-300 text-neutral-600 focus:border-primary-600 focus:ring-0" value="{{ old('end_date') }}">
                                @error('end_date')
                                    <div class="text-red-600">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-span-3 form-group">
                                ...
                                <select name="status" id="status" class="w-full p-3 rounded-lg border border-neutral-300 text-sm text-neutral-600 focus:border-primary-600 focus:ring-0">
                                    <option value="0" {{ (old('status') === 0) ? 'selected' : '' }}>{{ __db('not_completed') }}</option>
                                    <option value="1" {{ (old('status') === 1) ? 'selected' : '' }}>{{ __db('completed') }}</option>
                                </select>
                            ...
                            <div class="col-span-3">
                                ...
                                <select name="is_default" id="is_default" class="w-full p-3 rounded-lg border border-neutral-300 text-sm text-neutral-600 focus:border-primary-600 focus:ring-0">
                                    ...
                                    <option value="1" {{ (old('is_default') === 1) ? 'selected' : '' }}>{{ __db('yes') }}</option>
                                </select>
