                    ...
                    <div class="delegate-row border bg-white p-6 rounded bg-gray-100 mb-2">
                        <div class="grid grid-cols-12 gap-5">
                            ...
                            <div class="col-span-3">
                                ...
                                <input type="date" name="start_date" id="start_date" class=" p-3 rounded-lg w-full border text-sm border-neutral-300 text-neutral-600 focus:border-primary-600 focus:ring-0" value="{{ old('start_date') }}">
                                @error('start_date')
                                    <div class="text-red-600">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-span-3">
                                ...
                                <input type="date" name="end_date" id="end_date" class=" p-3 rounded-lg w-full border text-sm border-neutral-300 text-neutral-600 focus:border-primary-600 focus:ring-0" value="{{ old('end_date') }}">
                                @error('end_date')
                                    <div class="text-red-600">{{ $message }}</div>
                                @enderror
                            </div>
