                        ...
                        <div class="relative">
                            ...
                            <div class="flex">
                                ...
                                <select name="module" id="module"
                                    ...
                                    <option value="admin" {{ request()->module == 'admin' ? 'selected' : '' }}>
                                        {{ __db('admin') }}</option>
                                    <option value="delegate" {{ request()->module == 'delegate' ? 'selected' : '' }}>
                                        {{ __db('delegate') }}</option>
                                    <option value="escort" {{ request()->module == 'escort' ? 'selected' : '' }}>
                                        {{ __db('escort') }}</option>
                                    <option value="driver" {{ request()->module == 'driver' ? 'selected' : '' }}>
                                        {{ __db('driver') }}</option>
                                    <option value="hotel" {{ request()->module == 'hotel' ? 'selected' : '' }}>
                                        {{ __db('hotel') }}</option>
                                </select>
                                        ...
                                        <div class=" items-center">
                                            <label for="switch-{{ $key }}" class="relative inline-block w-11 h-6">
                                                <input type="checkbox" id="switch-{{ $key }}"
                                                    onchange="update_status(this)" value="{{ $staff->id }}"
