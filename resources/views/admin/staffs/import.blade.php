@extends('layouts.admin_account', ['title' => __db('import') . ' ' . __db('staffs')])

@section('content')
    <div   >
    <div class="flex flex-wrap items-center justify-between gap-2 mb-6">
        <h2 class="font-semibold mb-0 !text-[22px]">{{ __db('import') . ' ' . __db('staffs') }}</h2>
    ...
    <div class="bg-white h-full w-full rounded-lg border-0 p-30 mb-10">
        <div class="grid grid-cols-2 gap-8">
            <div class="border rounded-lg text-center p-10 block">
                <a href="{{ asset('assets/excel/sample_staffs.xlsx') }}" download
