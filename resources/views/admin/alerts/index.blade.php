        ...
        <div class="bg-white h-full w-full rounded-lg border-0 p-6">
                        ...
                        <div class="border border-neutral-200 rounded-lg p-4 hover:bg-gray-50">
                            <div class="flex justify-between items-start">
                                ...
                                <div class="flex gap-2">
                                    <a href="{{ route('alerts.show', $alert) }}" class="text-blue-600 hover:text-blue-800 text-sm">
                                        {{ __db('view_details') }}
                                    </a>
                                </div>
                            </div>
            ...
            @else
                <div class="text-center py-12">
                    ...
                    <div class="mt-6">
                        <a href="{{ route('alerts.create') }}" class="btn text-sm !bg-[#B68A35] flex items-center text-white rounded-lg py-2 px-3 mx-auto w-fit">
                            <svg class="w-6 h-6 text-white me-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 12h14m-7 7V5"/>
                            </svg>
                            <span>{{ __db('create_alert') }}</span>
