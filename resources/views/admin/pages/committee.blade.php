@extends('layouts.admin_account', ['title' => __db('edit') . ' ' . __db('committee') .' '. __db('page')])

@section('content')
<div class="space-y-6">

    <div class="flex items-center justify-between gap-2 mb-6">
        <h2 class="font-semibold text-2xl">{{ __db('edit') . ' ' . __db('committee') .' '. __db('page') }} - {{ $page->event?->getTranslation('name') }}</h2>
