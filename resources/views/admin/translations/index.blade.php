                        ...
                        <tr class="border-t text-[12px]">
                            ...
                            <td class="px-4 py-3 text-center " dir="ltr">
                                ...
                                @directCan('edit_labels')
                                    <button class=" edit-btn w-8 h-8  text-primary-600 dark:text-primary-400 rounded-full inline-flex items-center justify-center" data-modal-target="editTranslationModal" title="{{ __db('edit') }}"
