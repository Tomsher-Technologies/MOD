...
<script>
    ...
    function printSection(divId, chartId = null) {
            ...
            if (chartId) {
                ...
                if (chart) {
                    ...
                    img.onload = () => {
                        ...
                        const chartContainer = clonedContent.querySelector('#AcceptedContinents');
                        if (chartContainer) {
        ...
        insertChartAsPNG(() => {
            ...
            const titleTable = "{{ __db('accepted_invitations_continents') }}";
            ...
            <div class="chart-section">
                ...
                <div class="chart-container">
                    ${clonedContent.querySelector('#AcceptedContinents')?.outerHTML || ''}
                </div>
            </div>
            `);
