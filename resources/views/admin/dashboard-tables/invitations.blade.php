...
<script>
    document.addEventListener("DOMContentLoaded", () => {
        window.invitationChart = Highcharts.chart('InvitationStatus', {
            chart: {
                ...
                events: {
                    load: function() {
                        window.delChart = this; // store reference globally
                    }
                }
            },
            responsive: {
    ...
    function printSection(divId, chartId = null) {
            ...
            if (chartId) {
                ...
                if (chart) {
                    ...
                    img.onload = () => {
                        ...
                        const chartContainer = clonedContent.querySelector('#InvitationStatus');
                        if (chartContainer) {
        ...
        insertChartAsPNG(() => {
            ...
            const titleTable = "{{ __db('delegates_invitation_status') }}";
            ...
            <div class="chart-section">
                ...
                <div class="chart-container">
                    ${clonedContent.querySelector('#InvitationStatus')?.outerHTML || ''}
                </div>
            </div>
            `);
