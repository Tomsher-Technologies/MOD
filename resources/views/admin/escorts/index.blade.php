   ...
   <div class="xl:col-span-12 h-full">
      <div class="bg-white h-full vh-100 max-h-full min-h-full rounded-lg border-0 p-6">
         ...
         <table class="table-auto mb-0 !border-[#F9F7ED] w-full">
            <thead>
               <tr>
                  <th scope="col" class="p-3 !bg-[#B68A35] text-start text-white border !border-[#cbac71]">Sl.No</th>
                  <th scope="col" class="p-3 !bg-[#B68A35] text-start text-white border !border-[#cbac71]">Military Number</th>
                  <th scope="col" class="p-3 !bg-[#B68A35] text-start text-white border !border-[#cbac71]">Title</th>
                  <th scope="col" class="p-3 !bg-[#B68A35] text-start text-white border !border-[#cbac71]">Name</th>
                  <th scope="col" class="p-3 !bg-[#B68A35] text-start text-white border !border-[#cbac71]">Mobile Number</th>
            ...
            <tbody>
               ...
               <tr class="text-sm align-[middle]">
                   <td class="px-4 py-2 border border-gray-200">{{ $key + 1 + ($escorts->currentPage() - 1) * $escorts->perPage() }}</td>
                  ...
                  <td class="px-4 py-3 border border-gray-200">{{ $escort->gender->name_en ?? 'N/A' }}</td>
                  ...
                  <td class="px-4 py-3 !text-[#B68A35] border border-gray-200">
                    @if($escort->delegation)
                        <a href="{{ route('delegations.show', $escort->delegation->id) }}">{{ $escort->delegation->code }}</a>
                    @else
                        N/A
                    @endif
                  </td>
