                            ...
                            @foreach ($element as $page => $url)
                                @if ($page == $paginator->currentPage())
                                    <span aria-current="page">
                                        <span class="relative inline-flex items-center px-4 py-2 -ml-px text-sm font-medium text-white !bg-[#B68A35] border border-gray-300 cursor-default leading-5 dark:bg-[#B68A35]-800 dark:border-gray-600">{{ $page }}</span>
                                    </span>
                                @else
