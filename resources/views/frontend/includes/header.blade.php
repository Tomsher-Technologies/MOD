            ...
            <div class="flex items-center gap-6 text-md">
                ...
                <div class="relative" id="language-switcher-container">
                    ...
                    <div id="language-menu" class="absolute right-0 mt-2 w-32 bg-white rounded-md shadow-xl py-1 z-[100] hidden">
                        <a href="{{ route('lang.switch', ['lang' => 'en']) }}" class="block px-4 py-2 text-sm text-gray-800 hover:bg-gray-100 hover:text-[#b68a35]">English</a>
                        <a href="{{ route('lang.switch', ['lang' => 'ar']) }}" class="block px-4 py-2 text-sm text-gray-800 hover:bg-gray-100 hover:text-[#b68a35]">العربية</a>
                        </div>
                </div>
