                ...
                @php
                    $columns = [
                        ...
                        [
                            ...
                            'render' => function ($delegation) {
                                $buttons = '';
                                if (can(['edit_delegations', 'del_edit_delegations'])) {
                                    $buttons .=
                                        '<a href="' .
                                ...
                                if (can(['view_delegations', 'del_view_delegations', 'escort_view_delegations', 'driver_view_delegations', 'accommodation_view_delegations'])) {
                                    $buttons .=
                                        '<a href="' .
