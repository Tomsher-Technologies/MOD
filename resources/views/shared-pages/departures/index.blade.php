                    ...
                    $columns = [
                        ...
                        [
                            ...
                            'render' => function ($row) {
                                ...
                                if ($delegationId && $delegationCode !== '-') {
                                    ...
                                    return '<a href="' . $viewUrl . '" class="text-[#B68A35] hover:underline">' . e($delegationCode) . '</a>';
                                }
                        ...
                        [
                            ...
                            'render' => function ($row) {
                                ...
                                if ($delegationId) {
                                    $viewUrl = route('delegations.show', $delegationId);
                                    $viewButton = '<a href="' . $viewUrl . '" class="w-8 h-8 text-primary-600 dark:text-primary-400 rounded-full inline-flex items-center justify-center" title="' . __db('view_delegation') . '">
                                ...
                                $editButton = '<button type="button" class="edit-departure-btn w-8 h-8 text-primary-600 dark:text-primary-400 rounded-full inline-flex items-center justify-center ml-1" data-departure=\'' .
                                    $json .
