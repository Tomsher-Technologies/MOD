        ...
        <div class="xl:col-span-12 h-full">
            <div class="bg-white h-full vh-100 max-h-full min-h-full rounded-lg border-0 p-6">
                ...
                <div class="flex items-center justify-between  w-full">
                    <h2 class="font-semibold mb-0 !text-[22px] hide-when-fullscreen">{{ __db('departures') }}</h2>
                    ...
                    <div class="flex items-center gap-4  w-full justify-between mb-5">
                        ...
                        <h2 class="font-semibold mb-0 text-[40px] hidden full-screen-logo ">{{ __db('departures') }}
                        </h2>
