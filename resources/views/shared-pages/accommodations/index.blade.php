<div>
    ...
    <div class="flex flex-wrap items-center justify-between gap-2 mb-6">
        ...
        <div>
            ...
            @directCanany(['add_accommodations', 'hotel_add_accommodations', 'import_accommodations',
            'hotel_import_accommodations'])
        ...
        @directCanany([
            'view_external_members',
            'assign_external_members',
            'hotel_view_external_members',
                    ...
                    <form method="GET" class="ml-4 mt-2">
                        ...
                        <select id="limit" name="limit" onchange="this.form.submit()"
                            ...
                            @foreach ([10, 25, 50, 100] as $size)
                                <option value="{{ $size }}"
                                    {{ request('limit', 10) == $size ? 'selected' : '' }}>
                                    {{ $size }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    @forelse ( $accommodations as $key => $hotel )
                        <tr class="text-[12px] align-[middle]">
                            ...
                            <td class="text-center px-3 py-3 border border-gray-200">
                                @directCanany([
                                    'view_accommodations',
                                    'delegate_view_accommodations',
                                    'escort_view_accommodations',
                                    'driver_view_accommodations',
                                    'hotel_view_accommodations'
                                ])
                                    <a href="{{ route('accommodations.show', base64_encode($hotel->id)) }}"
                            ...
                            <td class="text-center px-3 py-2 border border-gray-200">
                                <div class="flex align-center gap-1">
                                    ...
                                    @directCanany(['export_hotel_accommodations', 'hotel_export_hotel_accommodations'])
                                        <a href="{{ route('accommodations.export-hotel', base64_encode($hotel->id)) }}"
                                            title="{{ __db('export_to_excel') }}"
                                            class="w-8 h-8  text-primary-600 dark:text-primary-400 rounded-full inline-flex items-center justify-center">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                                                viewBox="0 0 24 24" fill="none" stroke="#7C5E24" stroke-width="2"
