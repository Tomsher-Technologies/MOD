                    ...
                    $columns = [
                        ...
                        [
                            ...
                            'render' => function ($row) {
                                ...
                                $editButton = '<button type="button" class="edit-arrival-btn w-8 h-8 text-primary-600 dark:text-primary-400 rounded-full inline-flex items-center justify-center ml-1" data-arrival=\'' .
                                    $json .
