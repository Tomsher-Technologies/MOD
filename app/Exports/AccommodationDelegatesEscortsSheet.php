...
class AccommodationDelegatesEscortsSheet implements FromCollection, WithHeadings, WithMapping, WithStyles, WithEvents
{
    protected $data;
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $sheet->setCellValue('A1', 'Accommodation Delegates & Escorts Export - Exported on: ' . Carbon::now()->format('d-m-Y H:i A'));
